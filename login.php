...
<body class="bg-dark text-light d-flex flex-column justify-content-center align-items-center vh-100">
    ...
    <div class="card bg-secondary text-light" style="width: 100%; max-width: 360px;">
        <div class="card-body">
            ...
            <p class="card-text">Faça login para continuar</p>
            <form action="login.php" method="post">
                ...
                <?php endif; ?>
                <div class="mb-3">
                    <span class="form-text">Não tem uma conta?<a href="cadastro.php" class="link-dark fw-semibold ms-1">Crie uma</a></span>
                </div>
                <button type="submit" class="btn btn-dark w-100">Entrar &rarr;</button>
            </form>
        </div>
    </div>
